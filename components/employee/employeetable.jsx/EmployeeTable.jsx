...
//                 .map((candidate) => (
//                   <TableRow key={candidate.id} sx={{ borderBottom: '0.7px dotted #ccc'}}>
//                     <TableCell>{candidate.id}</TableCell>
//                     <TableCell>{candidate.name}</TableCell>
//                     <TableCell>{candidate.designation}</TableCell>
//                     <TableCell  sx={{
//                         backgroundColor: candidate.status === "inactive" ? "#FF505033" : "#00800033",
//                         color: candidate.status === "inactive" ? "red" : "green",
//                         padding: "7px",
//                         borderRadius: "4px",
//                         marginTop:'20px',
//                         textAlign:'center',
...
//                          <Edit />
//                 </IconButton>
//                       <IconButton aria-label="menu" onClick={(event) => handleClickMenu(event, candidate.id)}>
//     <MoreVert />
//   </IconButton>
//   <Menu
//     id="candidate-menu"
...
//    */}
//      <MenuItem onClick={() => handleMenuItemClick("edit")} dense >
//     <Edit />
...
//     <>
//       <MenuItem onClick={() => handleMenuItemClick("inactive")} dense>
//         <DoNotDisturbAltIcon/>
//         <span style={{color:'black',marginLeft:'6px'}}>Inactive</span>
//       </MenuItem>
//       <MenuItem onClick={() => handleMenuItemClick("invitation")} dense>
//         <ShareIcon />
//         <span style={{marginLeft:'6px'}}>Invitation</span>
//       </MenuItem>
//     </>
//   ) : selectedCandidate && (
//     <>
//       <MenuItem onClick={() => handleMenuItemClick("active")} dense>
//         <StatusChangeIcon/>
//         <span style={{marginLeft:'6px'}}>Activate</span>
//       </MenuItem>
//       <MenuItem onClick={() => handleMenuItemClick("delete")} dense>
//         <DeleteOutlineIcon/>
