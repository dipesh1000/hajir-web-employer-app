    ...
    <Container maxWidth="md">
      <Paper elevation={3} style={{ padding: '20px', textAlign: 'center' }}>
        ...
        <Typography variant="body1">
          ...
          revocable license to use the App for your personal or business use.
          <br />
          <strong>2.2 User Account:</strong> To access certain features of the
          App, you may be required to create an account. You are responsible for
          maintaining the confidentiality of your account information.
          <br />
          <strong>2.3 Prohibited Activities:</strong> You agree not to engage in
          any prohibited activities, including but not limited to unauthorized
